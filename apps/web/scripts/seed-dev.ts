...
const peluqueriaShots = [
  ...
  },
  {
    ...
    alt: "Booking público responsive de peluqueria-agenda para elegir servicio, profesional y horario",
    width: 1440,
    height: 3637,
  },
  {
    src: "/work/peluqueria-agenda/landing-ramonas.png",
    alt: "Landing pública RAMONAS conectada al flujo de reserva online",
    width: 1440,
    height: 8106,
  },
];
...
const consultaStockShots = [
  {
    ...
    alt: "Consulta Stock General en modo interno de escritorio con búsqueda por producto o familia",
    width: 1440,
    height: 900,
  },
  {
...
const calculadoraShots = [
  {
    ...
    alt: "Calculadora pública Anclaflex para ingresar metros cuadrados y seleccionar productos o sistemas",
    width: 1440,
    height: 1100,
  },
  {
    src: "/work/calculadora-materiales-anclaflex/resultado-calculo-desktop.png",
    alt: "Resultado de cálculo Anclaflex con desglose por mano, envases, costos y descarga PDF",
    width: 1440,
    height: 1267,
  },
  {
...
const sector07Shots = [
  ...
  },
  {
    ...
    alt: "Sector 07 Control con búsqueda operativa por cliente, nota de pedido, producto u observacion",
    width: 1440,
    height: 1100,
  },
  {
...
try {
  ...
  await db
    ...
    .values({
      ...
      evidenceNote: "Proyecto local verificado con suite UI + API, booking público, panel por roles y Cloudflare Tunnel documentado.",
    ...
    .values([
      {
        ...
        summary:
          "Sistema full-stack para operar un salon: agenda privada por roles, clientes, servicios, profesionales, booking público, confirmación por email y reportes operativos.",
        ...
        seoDescription: "Sistema full-stack para salon con agenda, booking público, roles, reportes, email y despliegue Docker/Cloudflare.",
      },
      {
        projectId: peluqueriaProjectId,
        locale: "en",
    ...
    .values([
      {
        ...
        title: "Peluqueria Agenda",
        dek:
          "Un MVP privado para que un salón gestione turnos, clientes, equipo y reportes, con booking público conectado al flujo real de confirmación y cancelación por email.",
        ...
        contentBlocks: [
          {
            type: "paragraph",
            markdown:
              "El problema era convertir una operación de salón en un sistema trazable: recepción necesita cargar y mover turnos rápido, profesionales necesitan ver sólo su agenda, administración necesita reportes y el cliente final necesita reservar sin depender de mensajes manuales.",
          },
          {
            type: "heading",
            level: 2,
          ...
          },
          {
            ...
            items: [
              ...
              "Alta, edición, reprogramación, reasignación, cancelación y operaciones masivas sobre turnos.",
              "Bloqueos de agenda por profesional, filtros operativos y validación de disponibilidad real.",
              "Booking público responsive con selección de servicio, profesional y horario.",
              "Confirmación o cancelación por email mediante links dedicados y vencimiento controlado.",
              "Reportes diarios, semanales y mensuales para leer ocupación e ingresos sin exportaciones manuales.",
              "Landing pública RAMONAS conectada al flujo de reserva.",
            ],
          },
          {
            type: "image",
            src: "/work/peluqueria-agenda/panel-dashboard.png",
            alt: "Dashboard privado de peluqueria-agenda con métricas, agenda y navegación operativa",
            caption: "Panel privado: agenda, métricas y operación diaria desde un solo entorno.",
            width: 1440,
            height: 1324,
          },
          {
          ...
          },
          {
            ...
            items: [
              ...
              "Backend: NestJS 11 con autenticación JWT, permisos por rol y módulos de agenda, clientes, servicios, staff, settings y reportes.",
              "Datos: PostgreSQL con Prisma, seed de usuarios/negocio y Redis para soporte operativo.",
              "Infra: Docker Compose, servicios separados para web privada, booking público, API, worker, DB, Redis y Cloudflare Tunnel.",
          ...
          },
          {
            type: "image",
            src: "/work/peluqueria-agenda/booking-publico.png",
            alt: "Booking público de peluqueria-agenda con pasos para servicio, profesional, horario y datos del cliente",
            caption: "Booking público: flujo mobile-first para reservar sin intervención manual.",
            width: 1440,
            height: 3637,
          },
          {
            ...
            caption: "Landing RAMONAS: entrada pública al negocio y al sistema de reservas.",
            width: 1440,
            height: 8106,
          },
          {
            type: "metric",
            value: "21 passed",
            label: "Validación completa UI + API documentada para flujos críticos y permisos por rol.",
            evidence: "AGENTS.md de peluqueria-agenda, verificación local 2026-05-25.",
          },
          {
            type: "paragraph",
  ...
  await db
    ...
    .values({
      ...
      evidenceNote: "Deploy validado el 2026-07-07: 14.183 productos, 19 familias, tunnel público y health checks OK.",
    ...
    .values([
      {
        ...
        summary:
          "Consulta web de stock en vivo para ERP: una superficie interna LAN y otra externa mobile-first, con catálogo local, familias manuales, autenticación externa y lecturas controladas a SQL Server.",
        category: "integración ERP",
        role: "Arquitectura full-stack, API NestJS, frontends Next.js, seguridad de exposición y despliegue Docker/Cloudflare",
    ...
    .values([
      {
        ...
        seoTitle: "Consulta Stock General - portfolio Facundo Ceresa",
        seoDescription: "Caso de integración ERP para consultar stock en vivo desde interfaces web internas y externas.",
        contentBlocks: [
          {
            type: "paragraph",
            markdown:
              "El problema era que la consulta de stock dependía demasiado del contexto operativo del ERP: escritorio, red, VPN y conocimiento interno. El proyecto concentra esa lectura en una API propia y ofrece dos superficies web según el contexto de uso.",
          },
          {
            type: "heading",
            level: 2,
          ...
          },
          {
            ...
            items: [
              ...
              "Catálogo local en PostgreSQL, reducido a productos disponibles para Uruguay e importado desde planilla operativa.",
              "Búsqueda mixta de productos y familias desde 4 caracteres, con sugerencias limitadas y prioridad moderada para familias.",
              "Familias manuales con reglas explícitas, por prefijo y por coincidencia parcial para agrupar artículos reales del ERP.",
              "Superficie interna LAN sin login de usuario, protegida por proxy server-side y token interno entre frontend y API.",
              "Superficie externa mobile-first con usuario, contraseña, sesión por cookie HTTP-only y publicación vía Cloudflare Tunnel.",
              "API central que evita SQL libre o filtros arbitrarios y controla todas las consultas al ERP.",
              "Consultas por familia en batches para evitar el límite de 2100 parámetros de SQL Server.",
              "Exposición endurecida: API y frente externo en loopback, frente interno por allowlist LAN/VPN y dominio público solo por tunnel.",
            ],
          },
          {
            type: "image",
            ...
            caption: "Frente interno: búsqueda de producto o familia para operadores dentro de la red.",
            width: 1440,
            height: 900,
          },
          {
          ...
          },
          {
            ...
            items: [
              ...
              "Backend: NestJS con módulos de autenticación, catálogo, stock, health y refresh manual de familias.",
              "Datos propios: PostgreSQL 16 para catálogo, familias manuales, usuarios, sesiónes y auditoría.",
              ...
              "Calidad operativa: health checks, restore validado, importadores de catálogo y tests de API/operaciones.",
            ],
          },
          {
            type: "image",
          ...
          },
          {
            ...
            caption: "La misma superficie externa mantiene una lectura clara también en escritorio.",
            width: 1440,
            height: 900,
          },
          {
          ...
          {
            type: "paragraph",
            markdown: `[Repositorio en GitHub](${consultaStockRepoUrl}) · [Aplicación publicada](${consultaStockLiveUrl})`,
          },
        ],
      },
      {
  ...
  await db
    ...
    .values({
      ...
      sortOrder: 3,
      metricValue: "3 apps",
      metricLabelKey: "API + público + admin",
      repoUrl: calculadoraRepoUrl,
      liveUrl: calculadoraLiveUrl,
      evidenceNote: "Proyecto desplegado y validado el 2026-07-16: cálculo público, PDF, API ready y admin LAN operativos.",
    ...
    .values([
      {
        ...
        category: "cotizador técnico",
        role: "Arquitectura full-stack, motor de cálculo, API, frontend público, admin, PDF e infraestructura Docker/Cloudflare",
    ...
    .values([
      {
        ...
        title: "Calculadora Materiales Anclaflex",
        dek:
          "Un cotizador público para convertir metros cuadrados en cantidades, envases y costos estimados, con un motor de cálculo backend, presupuestos persistidos como snapshot y PDF descargable.",
        category: "cotizador técnico",
        ...
        contentBlocks: [
          ...
          },
          {
            ...
            items: [
              ...
              "Incluye panel administrativo para productos, sistemas, empresa, configuración PDF, auditoría y carga de imágenes.",
              "Separa web pública, web admin y API para aplicar reglas distintas de exposición, CORS, cookies y Cloudflare.",
            ],
          },
          {
            type: "image",
            src: "/work/calculadora-materiales-anclaflex/calculadora-publica-desktop.png",
            alt: "Calculadora pública Anclaflex para cargar area y seleccionar producto o sistema",
            caption: "Calculadora pública: entrada clara para superficie, producto o sistema y ayuda contextual.",
            width: 1440,
            height: 1100,
          },
          {
          ...
          },
          {
            ...
            items: [
              ...
              "Motor de cálculo en TypeScript puro: expansión de sistemas, manos, consolidación, envases, costos y snapshots.",
              "Frontends Next.js 15 y React 19 con Tailwind, React Hook Form, Zod y componentes propios.",
              "Autenticación administrativa con Argon2, cookie HttpOnly/SameSite, sesiónes hasheadas y CSRF en mutaciones.",
              "PDF backend con Playwright Core + Chromium a partir del snapshot persistido, no desde captura de pantalla.",
              "Infraestructura Docker Compose con PostgreSQL 16-alpine, volúmenes persistentes, Cloudflare Tunnel y admin por LAN.",
            ],
          },
          {
            type: "image",
          ...
          },
          {
            type: "image",
            src: "/work/calculadora-materiales-anclaflex/calculadora-publica-mobile.png",
            alt: "Calculadora pública Anclaflex responsive en mobile",
            caption: "Vista mobile: el mismo flujo de cotización adaptado para consulta rápida.",
            width: 390,
            height: 1694,
          },
          {
            type: "metric",
            value: "3 apps",
            label: "API NestJS, web pública y panel administrativo desplegados como servicios separados.",
            evidence: "README.md y DOCS/PROJECT_STATUS.md del repositorio privado.",
          },
          {
            type: "metric",
            value: "PDF A4",
            label: "PDF generado desde snapshot persistido y validado con cabecera %PDF- en producción.",
            evidence: "DOCS/PROJECT_STATUS.md, validación actualizada el 2026-07-16.",
          },
          {
            type: "paragraph",
            markdown: `[Repositorio en GitHub](${calculadoraRepoUrl}) · [Aplicación publicada](${calculadoraLiveUrl})`,
          },
        ],
      },
      {
        ...
        contentBlocks: [
          ...
          },
          {
            ...
            items: [
              ...
              "Pure TypeScript calculation engine: system expansión, coats, consolidation, packages, costs and snapshots.",
        ...
        contentBlocks: [
          {
            type: "paragraph",
            markdown:
              "El problema era operativo: el sector 07 necesitaba ver y actualizar la preparación de notas de pedido sin depender de una planilla manual ni escribir en la base oficial del ERP. La solución separa lectura ERP, snapshot local y estados propios.",
          },
          {
            type: "heading",
            level: 2,
          ...
          },
          {
            ...
            items: [
              ...
              "Permite cambiar estado de pedido, estado de item, fecha de entrega, nota operativa, cantidad operativa y borrado lógico local.",
              "Sincroniza incrementalmente por cursor `FCRMVH_NROFOR`, trayendo solo notas nuevas.",
              "Incluye actualización manual desde UI y soporte de sync automático configurable por ventana horaria.",
              "Emite eventos en tiempo real por WebSocket y usa polling de respaldo si se corta la conexión.",
          ...
          },
          {
            ...
            items: [
              ...
              "Frontend: React 18 con Vite 6, TypeScript y CSS propio optimizado para pantalla fija de operación.",
          ...
          },
          {
            ...
            caption: "Viewport reducido: conserva la mesa desktop-first pensada para operación interna.",
            width: 1392,
            height: 3013,
          },
          {
            type: "metric",
            value: "499",
            label: "Pedidos restaurados en erp_order_header tras migración al servidor flexservice.",
            evidence: "docs/deploy-status-2026-07-07.md del repositorio privado.",
          },
          {
            type: "metric",
  ...
  for (const [index, title] of draftProjectCandidates.entries()) {
    ...
    if (projectId) {
      ...
      await db.insert(projectTranslations).values([
        { projectId: project.id, locale: "es", slug: draftSlugEs, title, summary: "Borrador de desarrollo. No publicar sin contenido real, evidencias y traducción revisada.", category: "borrador" },
